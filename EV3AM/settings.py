"""
Django settings for EV3AM project.
...
SECRET_KEY = 'django-insecure-e0rm@qszll!6=*yt2fk7f13eh^ef%flcy1g#%talti1=0z9ofh'
...
WSGI_APPLICATION = 'EV3AM.wsgi.application'
